<template>
    <div class="reglaze-page">
            ...
            <b-row>
                <b-col cols="12" class="d-flex flex-column justify-content-center">
                    ...
                    <p class="d-inline justify-content-center text-center mt-2">
                        Give your favourite pair of prescription glasses (or sunglasses) a new lease of life with our premium lens replacement service starting from only
                        <strong>$49.00</strong> including lenses. Offering great value, this service is perfect for those looking to extend the life of their existing eyewear.
                    </p>

                    <img
                        class="reglaze-section__image mt-4"
                        src="https://d9qzjwuieyamt.cloudfront.net/5.6.1.36/res/images/banners/reglaze/reglaze.jpg?20220127113847"
                        alt="glasses"
                        title="buy new one"
                    />
                </b-col>
        ...
        <div class="reglaze-cards-section my-4 py-4">
            <custom-container>
                <b-row class="d-flex justify-content-between">
                    <b-col cols="12" sm="4" v-for="i of 3" :key="i">
                        <b-card class="reglaze-cards-section__card my-4">
                            ...
                            <b-card-text class="d-flex flex-column align-items-center">
                                ...
                                <b-button
                                    ...
                                    :size="$screen.lg || $screen.mobile ? `lg` : null"
...
<style lang="scss">
$reglaze-cards-section-border-color-hover: #ffa200;
...
.reglaze-section {
    font-size: $reglaze-cards-section-font-size;
...
.reglaze-cards-section {
    background-color: $reglaze-cards-section-bg-color;

    &__price {
        color: $reglaze-cards-section-border-color-hover;
        font-size: 2em;
    ...
    &__button {
        background-color: $reglaze-cards-section-border-color-hover;
        border: none;
        font-size: 1em;
        width: 200px;
        height: 50px;
    ...
    &__card {
        border: $reglaze-cards-section-border-width solid
            $reglaze-cards-section-border-color;
        transition: border-color ease-in-out 0.5s;
        cursor: pointer;

        &:hover {
            border-color: $reglaze-cards-section-border-color-hover;
        }
    }
}
</style>
